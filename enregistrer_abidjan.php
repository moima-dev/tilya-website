...
$sql = "INSERT INTO preinscriptions_abidjan (eleve_nom, eleve_prenom, parent_nom, parent_prenom, parent_phone, parent_email, lieu_habitation, ecole, date_soumission, ip_address) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
